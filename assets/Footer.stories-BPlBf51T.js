import{i as e}from"./preload-helper-xPQekRTU.js";import{$ as t,C as n,Ct as r,I as i,It as a,Lt as o,Ot as s,Q as c,Ut as l,V as u,X as d,a as f,at as p,bt as m,et as h,g,gt as _,i as v,kt as ee,ot as y,q as b,qt as x,s as S,st as C,t as w,ut as te,w as ne,xt as T,y as re}from"./iframe-CIRq0HXM.js";import{a as E,i as D,n as O,r as k,t as ie}from"./create-runtime-stories-7PQW_Jro.js";import{n as ae,t as oe}from"./cn-DIUhmm-p.js";import{n as A,t as j}from"./Button-DyhrVrmZ.js";import{E as se,M as ce,O as le,W as ue,g as de,i as fe,t as M,v as pe}from"./icons-BD3KpF_Q.js";import{n as me,t as N}from"./ColorButton-tOQw-0WI.js";import{n as he,t as ge}from"./ProgressiveBlur-Bg9oLE9t.js";function P(e,i){o(i,!0);let d=v(i,`showCloseButton`,3,!1),p=v(i,`closeAriaLabel`,3,`Close`),h=f(i,F),x=ee(!1);var S=_e();g(S,e=>({class:e,...h}),[()=>oe(`fixed bottom-0 left-0 right-0 z-50 w-full flex items-center px-xl py-l pointer-events-none`,i.class)]);var w=m(S);ge(w,{edge:`bottom`,class:`-z-10`});var E=r(w,2),D=m(E),O=e=>{var a=L(),o=m(a),f=e=>{var t=I();fe(m(t),{class:`size-6`,stroke:1.5,"aria-hidden":`true`}),l(t),_(e=>{n(t,1,e),re(t,`aria-label`,p())},[()=>ne(oe(`size-12 shrink-0 inline-flex items-center justify-center rounded-rounded bg-layer-ghost text-icon backdrop-blur-[0.625rem]`,`cursor-pointer transition-transform duration-150 hover:opacity-90 outline-none focus-visible:kds-selected`,te(x)&&`scale-[0.98]`))]),y(`click`,t,function(...e){i.onCloseClick?.apply(this,e)}),y(`pointerdown`,t,()=>s(x,!0)),y(`pointerup`,t,()=>s(x,!1)),C(`pointerleave`,t,()=>s(x,!1)),C(`pointercancel`,t,()=>s(x,!1)),y(`keydown`,t,e=>{(e.key===`Enter`||e.key===` `)&&s(x,!0)}),y(`keyup`,t,()=>s(x,!1)),c(e,t)};u(o,e=>{d()&&e(f)});var h=r(o,2),g=e=>{var n=t();b(T(n),()=>i.left),c(e,n)};u(h,e=>{i.left&&e(g)}),l(a),c(e,a)};u(D,e=>{(d()||i.left)&&e(O)});var k=r(D,2),ie=e=>{var t=R();b(m(t),()=>i.children),l(t),c(e,t)};u(k,e=>{i.children&&e(ie)});var ae=r(k,2),A=e=>{var t=z();b(m(t),()=>i.right),l(t),c(e,t)};u(ae,e=>{i.right&&e(A)}),l(E),l(S),c(e,S),a()}var F,I,L,R,z,_e,ve=e((()=>{x(),w(),ae(),he(),M(),F=new Set([`$$slots`,`$$events`,`$$legacy`,`children`,`left`,`right`,`showCloseButton`,`onCloseClick`,`closeAriaLabel`,`class`]),I=h(`<button type="button"><!></button>`),L=h(`<div class="flex items-center gap-s shrink-0"><!> <!></div>`),R=h(`<div class="absolute left-1/2 -translate-x-1/2 flex items-center gap-s"><!></div>`),z=h(`<div class="ml-auto flex items-center gap-s shrink-0"><!></div>`),_e=h(`<footer><!> <div class="pointer-events-auto relative flex items-center w-full max-w-full min-h-12"><!> <!> <!></div></footer>`),p([`click`,`pointerdown`,`pointerup`,`keydown`,`keyup`]),P.__docgen={data:[{name:`children`,visibility:`public`,description:`Main action, horizontally centered (e.g. a primary Button).`,keywords:[],kind:`let`,type:{kind:`function`,text:`Snippet<[]>`},static:!1,readonly:!1},{name:`left`,visibility:`public`,description:`Left-zone content (e.g. a label or extra buttons).`,keywords:[],kind:`let`,type:{kind:`function`,text:`Snippet<[]>`},static:!1,readonly:!1},{name:`right`,visibility:`public`,description:`Right-zone content (e.g. a danger button or an icon group).`,keywords:[],kind:`let`,type:{kind:`function`,text:`Snippet<[]>`},static:!1,readonly:!1},{name:`showCloseButton`,visibility:`public`,description:`Convenience: a close/back icon button at the start of the left zone.`,keywords:[],kind:`let`,type:{kind:`type`,type:`boolean`,text:`boolean`},static:!1,readonly:!1,defaultValue:`false`},{name:`onCloseClick`,visibility:`public`,description:`Close click handler.`,keywords:[],kind:`let`,type:{kind:`function`,text:`() => void`},static:!1,readonly:!1},{name:`closeAriaLabel`,visibility:`public`,description:`Aria label for the close button.`,keywords:[],kind:`let`,type:{kind:`type`,type:`string`,text:`string`},static:!1,readonly:!1,defaultValue:`"Close"`},{name:`class`,visibility:`public`,description:`Additional classes.`,keywords:[],kind:`let`,type:{kind:`type`,type:`string`,text:`string`},static:!1,readonly:!1}],name:`Footer.svelte`}}));function B(e,t){o(t,!1),S();var n=Se(),s=T(n);Y(s,{name:`Playground`,asChild:!0,children:(e,t)=>{P(e,{get left(){return q},children:(e,t)=>{j(e,{label:`Start workout`,kind:`primary`,size:`large`,onclick:()=>{}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{docs:{description:{story:`Playground: the Default kind - a centered primary action with a maximize control.`}},__svelteCsf:{rawCode:`<Footer left={maximizeButton}>
