import{i as e}from"./preload-helper-xPQekRTU.js";import{Ct as t,It as n,Lt as r,Q as i,Ut as a,bt as o,et as s,qt as c,s as l,t as u,xt as d}from"./iframe-CIRq0HXM.js";import{a as f,i as p,n as m,r as h,t as g}from"./create-runtime-stories-7PQW_Jro.js";import{n as _,t as v}from"./Button-DyhrVrmZ.js";import{At as y,S as b,t as x,u as S}from"./icons-BD3KpF_Q.js";function C(e,s){r(s,!1),l();var c=A(),u=d(c);O(u,{name:`Playground`,args:{kind:`primary`,size:`large`,label:`Start workout`},parameters:{docs:{description:{story:`Playground: every prop wired to live controls.`}},__svelteCsf:{rawCode:`<Button {...args} />`}}}),O(t(u,2),{name:`Overview`,asChild:!0,parameters:{layout:`padded`,controls:{disable:!0},docs:{description:{story:`Overview: all common variants composed in a single story.`}},__svelteCsf:{rawCode:`<div class="flex flex-col gap-6">
...
</div>`}},children:(e,n)=>{var r=k(),s=o(r),c=o(s);v(c,{kind:`primary`,label:`Primary`});var l=t(c,2);v(l,{kind:`secondary`,label:`Secondary`});var u=t(l,2);v(u,{kind:`tertiary`,label:`Tertiary`});var d=t(u,2);v(d,{kind:`ghost`,label:`Ghost`}),v(t(d,2),{kind:`danger`,label:`Danger`}),a(s);var f=t(s,2),p=o(f);v(p,{kind:`primary-with-icon`,get icon(){return w},"aria-label":`Add`});var m=t(p,2);v(m,{kind:`secondary-with-icon`,get icon(){return w},"aria-label":`Add`});var h=t(m,2);v(h,{kind:`icon`,get icon(){return T},"aria-label":`Delete`});var g=t(h,2);v(g,{kind:`ghost-with-icon`,size:`small`,label:`Lina`,get icon(){return E}});var _=t(g,2);v(_,{kind:`primary-with-icon`,get icon(){return w},"aria-label":`Add`,loading:!0}),v(t(_,2),{kind:`secondary-with-icon`,get icon(){return w},"aria-label":`Add`,disabled:!0}),a(f);var y=t(f,2),b=o(y);v(b,{kind:`primary`,size:`small`,label:`Small`}),v(t(b,2),{kind:`primary`,size:`large`,label:`Large`}),a(y);var x=t(y,2),S=o(x);v(S,{kind:`primary`,label:`Loading`,loading:!0});var C=t(S,2);v(C,{kind:`primary`,label:`Disabled`,disabled:!0}),v(t(C,2),{kind:`ghost`,size:`small`,label:`I don't have a code`,href:`#`}),a(x),a(r),i(e,r)},$$slots:{default:!0}}),i(e,c),n()}var w,T,E,D,O,k,A,j,M,N,P;e((()=>{c(),f(),p(),_(),x(),u(),m(),w=e=>{b(e,{class:`size-full`,stroke:1.5,"aria-hidden":`true`})},T=e=>{S(e,{class:`size-full`,stroke:1.5,"aria-hidden":`true`})},E=e=>{y(e,{class:`size-full`,stroke:1.5,"aria-hidden":`true`})},D={title:`lib/components/Button`,component:v,parameters:{layout:`centered`},argTypes:{kind:{control:`select`,options:[`primary`,`primary-with-icon`,`secondary`,`secondary-with-icon`,`tertiary`,`ghost`,`ghost-with-icon`,`icon`,`danger`]},size:{control:`inline-radio`,options:[`small`,`large`]},disabled:{control:`boolean`},loading:{control:`boolean`}}},{Story:O}=h(D),k=s(`<div class="flex flex-col gap-6"><div class="flex flex-wrap items-center gap-3"><!> <!> <!> <!> <!></div> <div class="flex flex-wrap items-center gap-3"><!> <!> <!> <!> <!> <!></div> <div class="flex flex-wrap items-center gap-3"><!> <!></div> <div class="flex flex-wrap items-center gap-3"><!> <!> <!></div></div>`),A=s(`<!> <!>`,1),C.__docgen={data:[],name:`Button.stories.svelte`},j=g(C,D),M=[`Playground`,`Overview`],N={...j.Playground,tags:[`svelte-csf-v5`]},P={...j.Overview,tags:[`svelte-csf-v5`]}}))();export{P as Overview,N as Playground,M as __namedExportsOrder,D as default};