import{i as e}from"./preload-helper-xPQekRTU.js";import{Bt as t,Dt as n,Mt as r,Nt as i,Tt as a,U as o,Vt as s,Yt as c,Zt as l,et as u,ft as d,nt as f,o as p,qt as m,t as h,wt as g}from"./iframe-jy6kbBjD.js";import{a as _,i as v,n as y,o as b,r as x,t as S}from"./create-runtime-stories-DqQPwOwK.js";import{r as C,t as w}from"./Button-RRifwrgh.js";import{H as T,It as E,b as D,t as O}from"./icons-C06IOHKX.js";import{n as k,t as A}from"./Card-ChfeNqfG.js";import{n as j,t as M}from"./Drawer-DAVRfBdW.js";import{n as N,t as P}from"./Header-XlLcukRp.js";import{n as F,t as I}from"./List-CHV81G6U.js";function L(e,l){s(l,!0);function f(e,t){R.getChannel().emit(`updateStoryArgs`,{storyId:e,updatedArgs:{open:t}})}let h=i(!1),_=Array.from({length:12},(e,t)=>({id:`w${t+1}`,title:`Workout ${t+1}`,subtitle:`${30+t*5}:00`}));var v=J(),y=a(v);W(y,{name:`Playground`,args:{open:!0,title:`Title`,onClose:()=>{}},template:(e,t=c,r=c)=>{var i=J(),s=a(i);M(s,p(t,{onClose:()=>f(r().id,!1),get footer(){return H},children:(e,t)=>{var n=K();I(g(n),{get items(){return _},onItemClick:()=>{}}),m(n),u(e,n)},$$slots:{default:!0}}));var l=n(s,2),d=e=>{var t=q();w(g(t),{label:`Open drawer`,kind:`primary`,size:`large`,onclick:()=>f(r().id,!0)}),m(t),u(e,t)};o(l,e=>{t().open||e(d)}),u(e,i)},$$slots:{template:!0},parameters:{docs:{description:{story:`Playground: the drawer wired to controls; close writes back to the arg.`}},__svelteCsf:{rawCode:`<Drawer {...args} onClose={() => setOpen(context.id, false)} {footer}>
