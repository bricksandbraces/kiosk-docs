import{i as e}from"./preload-helper-xPQekRTU.js";import{Bt as t,Dt as n,Tt as r,Vt as i,Zt as a,et as o,nt as s,qt as c,s as l,t as u,wt as d}from"./iframe-jy6kbBjD.js";import{a as f,i as p,n as m,o as h,r as g,s as _,t as v}from"./create-runtime-stories-DqQPwOwK.js";import{r as y,t as b}from"./Button-RRifwrgh.js";import{At as x,S,t as C,u as w}from"./icons-C06IOHKX.js";function T(e,a){i(a,!1),l();var s=M(),u=r(s);A(u,{name:`Playground`,args:{kind:`primary`,size:`large`,label:`Start workout`},parameters:{docs:{description:{story:`Playground: every prop wired to live controls.`}},__svelteCsf:{rawCode:`<Button {...args} />`}}}),A(n(u,2),{name:`Overview`,asChild:!0,parameters:{layout:`padded`,controls:{disable:!0},docs:{description:{story:`Overview: all common variants composed in a single story.`}},__svelteCsf:{rawCode:`<div class="flex flex-col gap-6">
  ...
  <!-- Button shapes: the \`--radius-button\` token as the floor timer sets it per organization; icon-only buttons stay circles. -->
  <div class="flex flex-wrap items-center gap-3">
